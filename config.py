...
STRATEGY_VERSION: str = "1.6.5"

# Brief description of current version
STRATEGY_VERSION_NOTE: str = "Version bump to 1.6.5 (no signal logic changes)"
...
class LiveConfig:
    ...
    target_loss_usd: float = 10.0  # target loss in USD for sizing (-1 ATR)
